...
string DDSConfInfo::CpusPerTask = "CpusPerTask";
string DDSConfInfo::MemorySizePerTask = "MemorySizePerTask";
string DDSConfInfo::Docker = "Docker";
string DDSConfInfo::ImageName = "ImageName";
